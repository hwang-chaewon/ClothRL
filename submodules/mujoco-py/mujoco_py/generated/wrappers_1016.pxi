...
cdef class PyMjModel(object):
    ...
    cdef void _set(self, mjModel* p):
        ...
        self._key_mactive = _wrap_mjtByte_1d(p.key_mactive, p.nkey)
    ...
    @property
    #*******바꾼부분***************************
    def name_siteadr(self): return self._name_siteadr #return self.ptr.name_siteadr
    @property
...
cdef class PyMjData(object):
    ...
    def get_mocap_active(self, name):
        body_id = self._model.body_name2id(name)
        mocap_id = self._model.body_mocapid[body_id]
        return self.mocap_active[mocap_id]

    def set_mocap_active(self, name, value):
        body_id = self._model.body_name2id(name)
        mocap_id = self._model.body_mocapid[body_id]
        self.mocap_active[mocap_id] = value
    ...
    cdef void _set(self, mjData* p, PyMjModel model):
        ...
        self._mocap_active = _wrap_mjtByte_1d(p.mocap_active, model.nmocap)
    ...
    @property
    def mocap_active(self): return self._mocap_active
    @property
